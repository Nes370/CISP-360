...
int main() {
    ...
    monthlyPayment = (monthlyRate * pow(1 + monthlyRate, numberOfMonths))
         / (pow(1 + monthlyRate, numberOfMonths) - 1) * loanAmount;
    ...
    cout << setw(24) << "Loan Amount:" << "  $ " << setw(8) << loanAmount << '\n'
        ...
        << setw(24) << "Number of Payments:" << "    " << setw(5) << numberOfMonths << '\n'
